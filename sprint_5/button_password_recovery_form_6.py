...
# --------Этап 2. Задание: вход через кнопку в форме восстановления пароля----------
...
# 2.Найди кнопку "Восстановить пароль" и кликни по ней
restore_password_button = WebDriverWait(driver, 10).until(
    EC.element_to_be_clickable((By.CSS_SELECTOR, ".Auth_login__3hAey > div:nth-child(3) > p:nth-child(2) > a:nth-child(1)"))
)
...
# 3.Найди кнопку "Войти" и кликни по ней
vhod_lk = WebDriverWait(driver, 10).until(
...
# Проверяем появилась ли форма "Вход"
...
# 5.Найди поле "Пароль" и заполни его
...
# 6.Найди кнопку "Войти" и кликни по ней
...
# -----------Вошли в ЛК через кнопку в форме восстановления пароля-----------
