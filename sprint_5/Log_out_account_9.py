...
# -----------------Этап 3. Проверь выход по кнопке «Выйти» в личном кабинете----------
...
# 6.Кликаем кнопку «Выйти из аккаунта»
constructor_button = WebDriverWait(driver, 20).until(
        EC.element_to_be_clickable((By.CSS_SELECTOR, ".Account_button__14Yp3"))
    )
constructor_button.click()

# Ждём возврата к главной странице авторизации - проверяем появилась ли кнопка "Войти"
login_button = WebDriverWait(driver, 20).until(
        EC.element_to_be_clickable((By.XPATH,
            "//button[contains(text(), 'Войти')] | //a[contains(text(), 'Войти')]"))
    )
