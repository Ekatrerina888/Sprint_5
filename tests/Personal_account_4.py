...
def test_login_via_personal_cabinet_button(driver):
    """
    Тест входа в личный кабинет через кнопку «Личный кабинет» на главной странице.
    ...
    # Шаг 2: Переход к форме входа через «Личный кабинет»
    ...
    logger.info("Нажата кнопка 'Личный кабинет'")
    ...
    assert "Вход" in login_form_title.text, "Форма входа не открылась после клика на 'Личный кабинет'"
